...
//        Log.e("getWishList", productDatum.getAddedToWishList().toString())
        ...
        if (productDatum.getAddedToWishList() == true) {
            ...
            holder.removeFromList.visibility = View.VISIBLE
            holder.addToWishList.contentDescription = "filled"
        }
        ...
        holder.addToWishList.setOnClickListener {
            if (holder.addToWishList.contentDescription.equals("empty")) {
                ...
                holder.addToWishList.startAnimation(animation)
                holder.addToWishList.contentDescription = "filled"
                Log.e("getWishList", productDatum.getId().toString())
                var callAdd: Call<Products?>? = APIInterface.createLocal()
                    .addToWishList("addToWishList", "1", productDatum.getId().toString())
                ...
                holder.addToWishList.contentDescription = "empty"
                holder.addToWishList.contentDescription = "empty"
                var callAdd: Call<Products?>? = APIInterface.createLocal()
            ...
            callAdd!!.enqueue(object : Callback<Products?> {
                override fun onResponse(call: Call<Products?>, response: Response<Products?>) {
                    try {
                        wishListArrayListTemp =
                            response.body()!!.getProductData() as ArrayList<ProductDatum>
                        holder.removeFromList.visibility = View.GONE
